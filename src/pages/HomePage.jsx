    ...
    return (
        <div className={`w-screen sm:pl-30 sm:pr-30 flex flex-col pt-10 sm:pt-15 items-center sm:items-start gap-5 ${theme === "dark" ? "bg-gray-900" : ""} transition-all duration-300 ease-in`}>
            ...
            <div className={`flex text-2xl gap-1 ${theme === "dark" ? "text-white": "text-black"}`}>
                ...
                <a href="https://psnprofiles.com/Anshiiii_oyee" target='_blank'><i className="ri-playstation-fill"></i></a>
                <a href="https://stackoverflow.com/users/30916799/ansh-arora" target='_blank'><i className="ri-stack-overflow-fill"></i></a>
                <a href="https://t.me/Ansh_oyee" target='_blank'><i className="ri-telegram-2-fill"></i></a>
                <a href="https://x.com/a_arora937" target='_blank'><i className="ri-twitter-x-fill"></i></a>
                <a href="https://www.youtube.com/@ansharora5396" target='_blank'><i className="ri-youtube-fill"></i></a>
                <a href="https://www.threads.com/@anshiii.oyee" target='_blank'><i className="ri-threads-fill"></i></a>
                <a href="https://discordapp.com/users/640845246133174272" target='_blank'><i className="ri-discord-fill"></i></a>
            </div>
        </div>
  )
}
