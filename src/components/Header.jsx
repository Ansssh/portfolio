...
const Header = ({ theme, setTheme }) => {
    ...
    return (
        <>
            ...
            <div
                ref={sideMenuRef}
                className={`fixed top-15 z-50 h-screen w-50 ${theme === "dark" ? "bg-gray-700 text-white" : "bg-gradient-to-r from-white to-gray-200"} transition duration-500 ease-in-out`}
                style={{ left: '-100%' }}
            >
                <div className='p-4'>
